...
function ClientTicker() {
  ...
  return (
    <div style={{ overflow: "hidden", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
    ...
    <section style={{ padding: "5rem 0", position: "relative" }}>
      <div style={wrap}>
        <div className="reveal">
          ...
          <p style={{ color: "rgba(240,237,232,0.7)", maxWidth: 640, marginBottom: 34 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 18 }}>
          {items.map((it, i) => (
            <div key={i} className="glass-card reveal" style={{ padding: 24 }}>
              ...
              <p style={{ color: "rgba(240,237,232,0.7)", fontSize: 14.5, marginBottom: 16 }}>{it.desc}</p>
...
export default function PmLandingPage() {
  useScrollReveal();
  return (
    <div style={{ background: "#0f0f0f", color: "#f0ede8", minHeight: "100vh" }}>
      <Nav />
      ...
      <section style={{ padding: "150px 0 80px", position: "relative" }}>
        <div style={wrap}>
          <div className="reveal">
            ...
            <p style={{ fontSize: 18, color: "rgba(240,237,232,0.75)", maxWidth: 660, margin: "22px 0 28px" }}>
            ...
            <div style={{ display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
              ...
              <span style={{ color: "rgba(240,237,232,0.5)", fontSize: 13 }}>20 min · keep the map either way</span>
            </div>
            <p
              style={{
                marginTop: 30,
            ...
            >
              I&apos;m not a consultant with slides. <strong style={{ color: "#f0ede8" }}>I build and run these
      ...
      <section style={{ padding: "10px 0 40px" }}>
        <div style={wrap}>
          <blockquote
            className="reveal"
            style={{ borderLeft: "3px solid #f5a623", paddingLeft: 22, maxWidth: 820, fontSize: 22, lineHeight: 1.45, fontWeight: 600 }}
          >
            ...
            <cite style={{ display: "block", marginTop: 14, fontSize: 14, fontWeight: 400, fontStyle: "normal", color: "rgba(240,237,232,0.55)" }}>
            ...
            {changes.map((c) => {
              ...
              return (
                <div key={c.n} className="glass-card reveal" style={{ padding: 24 }}>
                  ...
                  <p style={{ color: "rgba(240,237,232,0.7)", fontSize: 14.5 }}>{c.p}</p>
                </div>
              );
            })}
          </div>
      ...
      <section style={{ padding: "5rem 0" }}>
        <div style={{ ...wrap, display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 40, alignItems: "center" }} className="audit-grid">
              ...
              {auditChecks.map((c, i) => (
                <div key={i} style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                  <span className="check-circle">
                    <Check color="#0f0f0f" strokeWidth={3} />
                  </span>
                  <span style={{ fontSize: 15.5, color: "rgba(240,237,232,0.85)" }}>{c}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="glass-card reveal" style={{ padding: 30 }}>
            ...
            <p style={{ color: "rgba(240,237,232,0.7)", fontSize: 14.5, marginBottom: 18 }}>
            ...
            <p style={{ color: "rgba(240,237,232,0.5)", fontSize: 12.5, marginTop: 12 }}>
      ...
      {/* PM AI Box */}
      <section style={{ padding: "5rem 0", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={wrap}>
          <div className="reveal">
            ...
            <p style={{ color: "rgba(240,237,232,0.7)", maxWidth: 680, marginBottom: 28 }}>
            ...
            {boxItems.map((b, i) => {
              ...
              return (
                <div key={i} className="reveal" style={{ display: "flex", gap: 12, alignItems: "center", padding: "12px 0" }}>
                  <Icon size={18} color="#f5a623" style={{ flexShrink: 0 }} />
                  <span style={{ fontSize: 15, color: "rgba(240,237,232,0.88)" }}>{b.t}</span>
                </div>
              );
            })}
          </div>
          <p className="reveal" style={{ fontSize: 15, color: "rgba(240,237,232,0.7)" }}>
            <strong style={{ color: "#f0ede8" }}>Managed, from $3–5K/mo</strong> — less than a coordinator&apos;s salary,
      ...
      {/* Final CTA */}
      <section id="book" style={{ padding: "6rem 0", textAlign: "center", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <div style={wrap}>
          <h2 className="font-display reveal" style={{ fontSize: 34, marginBottom: 14 }}>
            See where AI wins your team hours back
          </h2>
          <p className="reveal" style={{ color: "rgba(240,237,232,0.7)", fontSize: 17, maxWidth: 560, margin: "0 auto 28px" }}>
          ...
          <p className="reveal" style={{ marginTop: 16, fontSize: 13, color: "rgba(240,237,232,0.5)" }}>
            Prefer email?{" "}
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.08)", padding: "26px 0", color: "rgba(240,237,232,0.5)", fontSize: 13 }}>
